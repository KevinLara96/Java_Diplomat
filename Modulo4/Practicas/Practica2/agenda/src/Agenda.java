...
public class Agenda {
	...
	public static void main(String[] args) {
		...
		TipoContacto laboral = serviciosCatalogos.cargaTipoContactoPorId(3); //obtencion de catalogo tipo contacto
		papa.setTipoContacto(laboral); //relacionamos contacto con tipo contacto
		
		MedioContacto celular = serviciosCatalogos.cargaMedioContactoPorId(3); //obtencion de catalogo de medio contacto
		...
		serviciosContactos.guardaContacto(papa); //guardamos al contacto*/
