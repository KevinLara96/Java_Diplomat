package dgtic.core.springcorerestuno;
...
class SpringCoreRestunoApplicationTests {
    ...
    void agregar() throws Exception {
        mock.perform(post("/agregarestudiante").contentType(MediaType.APPLICATION_JSON).content(
                "{\"cuenta\":\"A4\",\"nombre\":\"Alondra\",\"edad\":\"24\",\"materias\":[{\"id\":1,\"nombre\":\"Lógica\",\"creditos\":10},"
                        +
                        "{\"id\":2,\"nombre\":\"Programación\",\"creditos\":9}]}"))
                .andDo(print());
    }
    ...
    void actualizar() throws Exception {
        mock.perform(put("/modificarestudiante").contentType(MediaType.APPLICATION_JSON).content(
                "{\"cuenta\":\"A1\",\"nombre\":\"DGTIC\",\"edad\":\"24\",\"materias\":[{\"id\":1,\"nombre\":\"Lógica\",\"creditos\":10},"
                        +
                        "{\"id\":2,\"nombrw\":\"Programación\",\"creditos\":9}]}"))
                .andDo(print());
    }
