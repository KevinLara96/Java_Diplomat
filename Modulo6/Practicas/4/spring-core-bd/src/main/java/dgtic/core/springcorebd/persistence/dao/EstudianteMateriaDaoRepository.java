...
import dgtic.core.springcorebd.persistence.modelo.EstudianteMateria;
...
public class EstudianteMateriaDaoRepository implements EstudianteMateriaDao {
    ...
    public void cambiar(EstudianteMateria viejoEstudianteMateria,
        ...
        jdbc.update("update estudiante_materia set cuenta_etd=?,"
                + "id_mtr=? where "
                + "cuenta_etd=? and id_mtr=?", nuevoEstudianteMateria.getIdEstudiante(),
                nuevoEstudianteMateria.getIdMateria(), viejoEstudianteMateria.getIdEstudiante(),
