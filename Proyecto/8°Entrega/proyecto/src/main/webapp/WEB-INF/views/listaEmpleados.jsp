					...
					<table class="table table-striped table-bordered">
						...
						<c:forEach var="empleado" items="${empleados}">
							...
							<c:url var="updateLink"
								value="/empleados/actualizar/${empleado.idEmpleado}" />

							<c:url var="deleteLink" value="/empleados/eliminar">
								<c:param name="empleadoId" value="${empleado.idEmpleado}" />
							</c:url>
							...
							<tr>
								...
								<td>${empleado.rfc}</td>
								<td>${empleado.agencia.nombreAgencia}</td>
								<td>${empleado.puesto.puesto}</td>
								<td><a  href="${updateLink}" 
                                        class="btn btn-primary"
									    role="button">
                                            <spring:message code="label.empleado.editar" />
								    </a>
                                    &nbsp; 
                                    <a  href="${deleteLink}" 
