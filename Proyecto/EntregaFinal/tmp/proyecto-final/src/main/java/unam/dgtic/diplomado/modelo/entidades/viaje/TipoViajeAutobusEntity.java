...
public class TipoViajeAutobusEntity {
    ...
    public TipoViajeAutobusEntity() {
    }

    public TipoViajeAutobusEntity(Integer idTipoViajeAutobus, String tipoViajeAutobus) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        TipoViajeAutobusEntity other = (TipoViajeAutobusEntity) obj;
