...
public class ServicioViaje implements RepositorioViaje {
    ...
    public Iterable<ViajeEntity> obtenerViajes() {
        ...
        return (Iterable<ViajeEntity>) query.getResultList();
    }

    @Override
    public ViajeEntity obtenerViaje(Integer idViaje) {
        return em.find(ViajeEntity.class, idViaje);
    }
    ...
    public void eliminarViaje(Integer idViaje) {
        ViajeEntity viaje = obtenerViaje(idViaje);
        if (viaje != null) {
            em.getTransaction().begin();
            em.remove(viaje);
            em.flush();
    ...
    public void actualizarViaje(ViajeEntity viajeParam) {
        ViajeEntity viaje = obtenerViaje(viajeParam.getIdViaje());
        if (viaje != null) {
            em.getTransaction().begin();
